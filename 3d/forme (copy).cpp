			...
			case 2:
				{
					...
					P01 = P01.mult(1-inter01).add(P0.mult(inter01));
					P02 = P02.mult(1-inter02).add(P0.mult(inter02));
					P11 = P11.mult(1-inter11).add(P0.mult(inter11));
					P12 = P12.mult(1-inter12).add(P0.mult(inter12));
